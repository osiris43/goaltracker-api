...
RSpec.describe TimeframesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all timeframes as @timeframes" do
      ...
      expect(assigns(:timeframes)).to eq([timeframe])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested timeframe as @timeframe" do
      ...
      expect(assigns(:timeframe)).to eq(timeframe)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new timeframe as @timeframe" do
      ...
      expect(assigns(:timeframe)).to be_a_new(Timeframe)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created timeframe as @timeframe" do
        post :create, {:timeframe => valid_attributes}, valid_session
        expect(assigns(:timeframe)).to be_a(Timeframe)
        expect(assigns(:timeframe)).to be_persisted
      end

      it "redirects to the created timeframe" do
        post :create, {:timeframe => valid_attributes}, valid_session
        expect(response).to redirect_to(Timeframe.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved timeframe as @timeframe" do
        post :create, {:timeframe => invalid_attributes}, valid_session
        expect(assigns(:timeframe)).to be_a_new(Timeframe)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested timeframe" do
        timeframe = Timeframe.create! valid_attributes
        put :update, {:id => timeframe.to_param, :timeframe => new_attributes}, valid_session
        timeframe.reload
      ...
      it "redirects to the timeframe" do
        timeframe = Timeframe.create! valid_attributes
        put :update, {:id => timeframe.to_param, :timeframe => valid_attributes}, valid_session
        expect(response).to redirect_to(timeframe)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the timeframe as @timeframe" do
        timeframe = Timeframe.create! valid_attributes
        put :update, {:id => timeframe.to_param, :timeframe => invalid_attributes}, valid_session
        expect(assigns(:timeframe)).to eq(timeframe)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the timeframes list" do
      timeframe = Timeframe.create! valid_attributes
      delete :destroy, {:id => timeframe.to_param}, valid_session
      expect(response).to redirect_to(timeframes_url)
    end
  end
